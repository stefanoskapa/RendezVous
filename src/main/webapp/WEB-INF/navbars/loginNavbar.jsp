        ...
        <div class="container-fluid"><i class="fa fa-calendar" data-aos="zoom-in" data-aos-once="true" style="font-size: 57px;padding: 2px;margin: -14px;"></i><a class="navbar-brand" href="${pageContext.request.contextPath}/" style="height: 62px;margin: -6px;font-size: 25px;color: rgb(255,255,255);width: 220px;padding: 13px;">&nbsp;&nbsp;RendezVouz</a>
            ...
            <div class="collapse navbar-collapse" id="navcol-1" style="background-color: #24273a;margin: 11px;">
                <ul class="nav navbar-nav ml-auto">
                    <li class="nav-item" role="presentation"><a class="nav-link" style="color: #ffffff;font-size: 17px;/*padding: 7px;*/height: 42px;" href="${pageContext.request.contextPath}/login"><i class="fa fa-user-circle"></i>&nbsp;Login</a></li>
                    <li class="nav-item" role="presentation" style="/*width: 132px;*/">
                        <div class="nav-item dropdown" style="color: #ffffff;height: 35px;padding: 7px;"><a class="dropdown-toggle d-table-cell" data-toggle="dropdown" aria-expanded="false" style="color: rgb(255,255,255);font-size: 17px;height: 4px;width: 4px;margin: 5px; cursor: pointer;">&nbsp;<i class="fa fa-address-card"></i>&nbsp;Register</a>
                            <div
